...
import { UserPlus, User, Lock, Network } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="glass-panel-dark p-10 rounded-3xl w-[400px] relative overflow-hidden group neon-border">
        ...
        <div className="absolute -bottom-20 -left-20 w-40 h-40 bg-emerald-500 rounded-full mix-blend-screen filter blur-[60px] opacity-10 animate-pulse" style={{ animationDelay: '1s' }}></div>
        
        <div className="relative z-10">
          <div className="flex justify-center mb-6">
            <div className="bg-[#020408] p-4 rounded-2xl shadow-inner border border-cyan-900/60">
              <Network className="text-cyan-500 w-10 h-10 drop-shadow-[0_0_8px_rgba(6,182,212,0.8)]" />
            </div>
          </div>
          <h2 className="text-2xl font-black text-center text-white mb-2 tracking-widest uppercase neon-text">Initialize Entity</h2>
          <p className="text-center text-cyan-600/80 mb-8 font-mono text-xs uppercase tracking-widest">Join PneumoScan Network</p>
          ...
          <p className="mt-8 text-center text-cyan-700 font-mono text-xs uppercase tracking-widest">
            Registered Entity? <Link to="/login" className="text-cyan-400 font-bold hover:text-cyan-300 drop-shadow-[0_0_5px_rgba(6,182,212,0.5)] transition-colors">Authenticate</Link>
          </p>
        </div>
      </div>
    </motion.div>
